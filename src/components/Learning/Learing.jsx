  ...
  return (
    <Container fluid className="allCards mt-2 py-4 px-3">
      <div className="d-flex">
        <img id="linkedinImg" src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="linkedin" />
        <p className="learning ms-2 mb-2">LEARNING</p>
      </div>
      <div>
        <p className="competenze">Aggiungi nuove competenze con questi corsi, gratuiti per 24 ore</p>
      </div>
      ...
      <div className="d-flex align-items-center mt-3">
        <img
          ...
          alt=""
        />
        <p className="text-video text-truncate ms-2 fw-bold">Comunica con carisma</p>
      </div>
      <hr className="line" />
      <div className="d-flex align-items-center mt-3">
        <img className="videoImg" src="https://www.bitmat.it/wp-content/uploads/2022/06/manager.jpg" alt="" />
        <p className="text-video text-truncate ms-2 fw-bold">
