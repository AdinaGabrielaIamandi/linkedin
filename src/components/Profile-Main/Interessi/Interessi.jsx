...
const Interessi = () => {
    ...
    Aziende: [
      {
        titolo: "Esplorazione",
        follower: 19064614,
        img: "https://iqsyst.eu/wp-content/uploads/2020/05/Esplorazione-Persona.jpeg"
      },
      {
        titolo: "Sport",
        follower: 170234,
      ...
      },
      {
        titolo: "Cucina",
        follower: 500000,
        img: "https://abimis.com/wp-content/uploads/2019/02/cucinare-come-uno-chef-impiattamento-1.jpg"
      },
      {
        titolo: "Google.com",
        follower: 150000000,
  ...
  return (
    <Container className="allCards p-4 mt-2">
      ...
      <ul className="d-flex">
        {Object.keys(dataInteressi).map((element, i) => {
          if (selected === element)
            return (
              <li key={i} className="greenLink " onClick={() => setSelected(element)}>
                {element}
              </li>
            );
          else
        ...
        <Row>
          {dataInteressi[selected].map((element, index, arr) => {
            if (index < numberToDisplay)
              return (
                <Col key={index} xs={12} lg={columWeight} className="division">
                  <Row>
                    <Col xs={3}>
